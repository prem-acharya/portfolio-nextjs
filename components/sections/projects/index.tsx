...
const projects = [
  ...
  },
  {
    ...
    type: "Personal",
    demo: true,
    description: "Built a web app enabling users to create, customize, and download resumes with a real-time preview.",
  ...
  },
  {
    ...
    tags: ["PHP", "WordPress", "Plugin", "JavaScript", "CSS"],
    demoUrl: "#",
  ...
  },
  {
    ...
    type: "Personal",
    demo: false,
    description: "A system to control and monitor home devices such as AC and TV with real-time temperature tracking.",
